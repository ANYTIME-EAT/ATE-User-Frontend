      ...
      <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
        ...
        <div className="mb-6">
          ...
          <div className="mb-6">
            <input
              type="text"
              className="form-control block w-full px-4 py-2 text-sm font-normal text-gray-700 bg-white 
          ...
          <ButtonPrimary type="submit" className="inline-block px-7 py-3 bg-blue-600 text-white font-medium
