...
import PromotionalSectionStatistic from "./PromotionalSectionStatistic";

class ProfilePromotional extends Component {
  render() {
    return (
      ...
      {/* </div> */}
        ...
        <div className="flex h-auto w-screen flex-row grow">
              ...
              <ul className="space-y-2">
                <li>
                  ...
                  >
                    ...
                    <span className="ml-3">Manage Address</span>
                  </a>
                </li>
                <li>
                  <a
          ...
          <div className="bg-neutral-50 px-10 py-10">
            <h1 className="font-semibold text-2xl">Referral</h1>
          </div>
...
export default ProfilePromotional;
