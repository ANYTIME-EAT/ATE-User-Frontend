...
const ShoppingCart: FC<ShoppingCartProps> = ({ className = "" }) => {
    ...
    return (
        <>
            {showSidebar ? (
                ...
                <button
                    className=" fixed h-12 w-12  z-30 flex items-center cursor-pointer right-2 top-10 p-2.5 bg-white hover:bg-neutral-100 dark:bg-gray-900 dark:hover:bg-primary-200 rounded-xl shadow-xl border border-neutral-200 dark:border-primary-600 focus:outline-none text-white"
                ...
                >
                    ...
                    <div
                        className="bg-red-500 rounded-full justify-items-center items-center"
                        style={{
                            color: "white",
                            width: "1.5rem",
                            height: "1.5rem",
            ...
            > */}
            <div className={`top-0 right-0  z-40 mt-3 w-full max-w-sm fixed scroll-auto ease-in-out duration-300 ${showSidebar ? "translate-x-0 " : "translate-x-full"
                }`}>
                <div className={`rounded-2xl  bg-white dark:bg-neutral-800 overflow-hidden nc-custom-shadow-1 `}>
                    <div className="relative p-6 ">
                        ...
                        <div className="flex flex-col max-w-3xl p-1 space-y-2 sm:p-1 dark:bg-gray-900 dark:text-gray-100">
