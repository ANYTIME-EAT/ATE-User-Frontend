        ...
        <form onSubmit={(e) => {e.preventDefault(); handleSubmit()}}>
          <div className="flex flex-row items-center justify-center lg:justify-start">
            ...
            <button
              ...
              className="inline-block p-3 bg-blue-600 text-white 
          ...
          <div
            ...
            before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 
          ...
          <div className="text-center lg:text-left">
            {/* <button
              type="button"
              className="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug 
            ...
            <ButtonPrimary type="submit" className="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-sm leading-snug 
              uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 
              focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg 
