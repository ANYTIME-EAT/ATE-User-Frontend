      ...
      >
        ...
        >
          <div className="relative p-6 ">
                    ...
                    return [
                      <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                        <div className="flex w-full space-x-2 sm:space-x-4">
                          <img
                            className="flex-shrink-0 object-cover w-20 h-20 dark:border-transparent rounded outline-none sm:w-20 sm:h-20 dark:bg-gray-500"
                            src={getProductImg(item.id, item.author)}
                            alt={item.name}
                            loading="lazy"
                          />
                            ...
                            <div className="flex  ">
                              <div className="flex items-right px-2 py-1 pl-0 space-x-1">
                                <CustomInupt
                                  ...
                                  onChange={(e) => {
                                    editQuantity(item.id, item.type, e);
                                    setNewProduct(true);
                                  }}
                                />
                              </div>
                              <button
                                type="button"
                                className="flex items-center px-1 py-1 pl-0 space-x-1 fill-red-600"
                                onClick={() => {
            ...
            <div
              className={`bg-gray-50 dark:bg-white/5 p-5 rounded-3xl  mt-10 ${
                items.length > 0
                  ? "pointer-events-auto "
                  : "pointer-events-none "
              }  `}
