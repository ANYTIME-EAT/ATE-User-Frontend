...
const RestraurantPage: FC<RestraurantPageProps> = ({ data, changeAuthor,crrAuthor }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-black dark:bg-opacity-20 rounded-3xl ">
      ...
      >
        ...
        <ul className="pt-6 items-end text-end">
          {data.map((Menu: any, index: number) => (
            <li
              ...
              //  ${index === crrAuthor.id && "bg-gray-900"} `}
               className={`flex  rounded-md p-3 cursor-pointer text-end text-end items-end gap-x-4 
