...
export interface ComboSliderProps {
  className?: string;
...
const ComboSlider: FC<ComboSliderProps> = ({
  ...
  const UNIQUE_CLASS =
    "ComboSlider__" + uniqueClassName + useNcId();
  ...
  return (
    <div className={`nc-ComboSlider ${className}`}>
